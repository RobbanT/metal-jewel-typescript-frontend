class GameMainMenuScreen extends GameMenuScreen {
    private leftJewel: Sprite;
    private rightJewel: Sprite;
    ...
    constructor(canvas: Canvas, gameScreenManager: GameScreenManager, graphicsPath: string, soundPath: string) {
        ...
        this.buttonArray.push(
            new Button(
                new Rectangle(canvas.origin.x, canvas.origin.y + 58, 230, 45),
                `${graphicsPath}big-button.png`,
                `${graphicsPath}big-button-shade.png`,
                `${graphicsPath}font.png`,
                "Hi-Score",
                () => gameScreenManager.changeGameScreen(new GameHiScoreScreen(canvas, gameScreenManager, graphicsPath, soundPath), this),
                7,
                1,
                this.charsSprites
            )
        ...
        this.buttonArray.push(
            new Button(
                new Rectangle(canvas.origin.x, canvas.origin.y + 138, 230, 45),
                `${graphicsPath}big-button.png`,
                `${graphicsPath}big-button-shade.png`,
                `${graphicsPath}font.png`,
                "GitHub",
