class Button extends Sprite {
    ...
    constructor(rectangle: Rectangle, src: string, shadeSrc: string, text: string, onClick: Function) {
        super(rectangle, src);
    ...
    update(mousePositionX: number, mousePositionY: number, mouseDown: boolean, mouseClicked: boolean) {
