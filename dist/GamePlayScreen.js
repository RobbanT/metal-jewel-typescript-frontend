...
class GamePlayScreen extends GameMenuScreen {
    constructor(canvas, gameScreenManager, graphicsPath, soundPath) {
        ...
        this.jewel = new Jewel(`${graphicsPath}jewel-marked-square.png`, new Rectangle(400, 200, 800, 40), `${graphicsPath}blue-jewel-sprite-sheet.png`, 20, false, 120, true, new Vector(100, 100), new Vector(200, 200), new Vector(1, 1));
