...
class GamePlayScreen extends GameMenuScreen {
    constructor(canvas, gameScreenManager, graphicsPath, soundPath) {
        ...
        this.sounds.set("clusterSound", new Sound(`${soundPath}cluster.wav`, 0.5, false, 4));
        this.sounds.set("gameOverSound", new Sound(`${soundPath}game-over.wav`, 0.5, false, 1.25));
        this.sounds.set("newJewelsSound", new Sound(`${soundPath}new-jewels.wav`, 0.5, false, 1));
